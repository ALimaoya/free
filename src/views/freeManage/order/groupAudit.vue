<template>
  <div class="detail"  v-loading="loading"  element-loading-text="拼命加载中">
    ...
    <p class="button"><el-button type="primary" @click="yesAudit">审核通过</el-button><el-button @click="noAudit = true">审核失败</el-button></p>
    <el-dialog
        title="拒绝原因"
        :visible.sync="noAudit"
        width="30%"
        center
        :show-close="false"
        ...
        <span slot="footer" class="dialog-footer">
            <el-button @click="cancelNoAudit">取 消</el-button>
            <el-button type="primary" @click="confirmNoAudit">确 定</el-button>
        </span>
    </el-dialog>
