<template>
  <div class="auditing">
    <div class="title" >活动提交成功，等待<span v-if="this.type === 'flow'|| this.type === 'group'">活动开始</span><span v-if="this.type === 'group' || this.type === 'flow'">到达设定的任务开始时间</span><span v-else="this.type === 'tryout'">审批通过</span>即可上线</div>
    <!--<img src="" alt="" />-->
