<template>
  <div class="login-container">
    ...
    <el-dialog class="ruleBox" center :modal-append-to-body="false" :visible.sync="ruleVisible" width="60%" >
      ...
      <h2>服务协议</h2>
        <p>一、接受条款</p>
        <span class="pTitle">丫贝（sksj.yabei.shop）根据以下服务条款为您提供服务。 所提供的各项服务的所有权和运作权归丫贝平台所有。 服务条款的修改权归丫贝平台所有。这些条款可由丫贝随时更新，且毋须另行通知。 丫贝服务协议（以下简称“服务协议”）一旦发生变动，丫贝将在网页上公布修改内容。 修改后的服务协议一旦在网页上公布即有效代替原来的服务协议。 此外，当您使用丫贝特殊服务时，您和丫贝应遵守丫贝随时公布的与该服务相关的指引和规则。 前述所有的指引和规则，均构成本服务协议的一部分。
        ...
        <ul>
          ...
          <li>4)如有合理理由怀疑您提供的资料错误、不实、过时或不完整的，丫贝有权向您发出询问及/或要求改正的通知，并有权直接做出删除相应资料的处理，直至中止、终止对您提供部分或全部交易平台服务。 丫贝对此不承担任何责任，您将承担因此产生的任何直接或间接损失及不利后果。</li>
        </ul>
        <p>六、隐私权政策</p>
        <ul>
...
<script>
  ...
  import {   setMobile } from "@/utils/auth"
